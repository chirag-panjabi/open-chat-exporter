...
async function main(): Promise<void> {
  ...
  assert(chatInfo.platform === 'GOOG_CHAT', 'chat_info.platform should be GOOG_CHAT');
  assert(chatInfo.chat_name === 'Google Chat fixture', 'chat_info.chat_name should match override');
